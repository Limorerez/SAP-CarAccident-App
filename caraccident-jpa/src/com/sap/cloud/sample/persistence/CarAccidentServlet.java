...
public class CarAccidentServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CarAccidentServlet.class);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            emf = Persistence.createEntityManagerFactory("CarAccident", properties);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.getWriter().println("<p>Car Accident!</p>");
        try {
            appendPersonTable(response);
            appendAddForm(response);
        } catch (Exception e) {
            response.getWriter().println("Car Accident operation failed with reason: " + e.getMessage());
            LOGGER.error("Car Accident failed", e);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            response.getWriter().println("Car Accident operation failed with reason: " + e.getMessage());
            LOGGER.error("Car Accident operation failed", e);
        }
    }
    ...
    private void appendPersonTable(HttpServletResponse response) throws SQLException, IOException {
        ...
        try {
            ...
            List<Employee> resultList = em.createNamedQuery("AllEmployee").getResultList();
